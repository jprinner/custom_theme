        ...
        <div class="modal-content">
            <div class="zipcode inner">
                ...
                <form action="/zip-search" class="zip_search_form search_wrap" data-form="Search Pop Up">
                    <input type="number" class="zip_search_input modal-zip-search-input" id="zip-<?php echo $rand; ?>" name="zip" minlength="5" maxlength="5" placeholder="Search by Zip Code" pattern="\d*"/>
