    ...
    <div class="blue-container">
        <div class="container">
            ...
            <div class="top-container">
                ...
                <div class="more-providers">
                    ...
                    <form action="/zip-search" class="zip_search_form">
                        <input type="hidden" class="zip_search_input" id="zip" name="zip" minlength="5" maxlength="5" placeholder="Search by ZIP Code" pattern="\d*" value=""/>
            ...
            <div class="zip-results">
                ...
                <div class="zip_search_overview_qualifier common-style mt-md-4 mt-4"></div>
            </div>
        </div>
    </div>  
</section>