...
$blue_bg = get_field('vertical_box_background_color');
$blue_bg_current= ($blue_bg) ? 'bg-blue' : '';
...
if ($button_type == 'popup'){
	...
	if($hso_button['button_text_link']){
...
<section class="section-gray row-full <?php echo $blue_bg_current?>">
	<div class="container">
