...
while ( have_posts() ) :
	...
	<main class="locations-main">
				...
				<div class="">
					...
					<div class="input_wrap zip_search_form_wrapper" style="display:none;">
						<form action="" class="zip_search_form" data-form="Search Zip Results">
							<input type="number" class="zip_search_input" id="zip" name="zip" minlength="5" maxlength="5" placeholder="Search by Zip Code">
		...
		<section>
			...
			<div class="zip_search_overview zip_search_overview-load-height common-style mt-md-5 mt-4 mb-5" data-city='<?php echo $city;?>' data-state='<?php echo $state;?>' data-is-programmatic-city-page='<?php echo $is_programmatic_city_page;?>'>
				<div class="container zip-search-loader-container">
					<div class="zip-search-loader-container-inner border-radius-20 pt-5 pt-md-0 d-flex flex-column justify-content-md-center align-items-center">
