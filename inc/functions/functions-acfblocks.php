    ...
    if( function_exists('acf_register_block_type') ) {
        ...
        */
        ...
        acf_register_block_type(array(
            ...
            'title'             => __('Green Statistics Block'),
            'description'       => __('Green Statistics Block'),
            'render_template'   => 'template-parts/blocks/green-statistics.php',
            'category'          => 'formatting',
            'mode'              =>  'edit',
            'post_types'        => array('locations'),
        ));
        acf_register_block_type(array(
            'name'              => 'general-call-center',
            'title'             => __('General Call Center Block'),
            'description'       => __('General Call Center Block'),
            'render_template'   => 'template-parts/blocks/general-call-center.php',
            'category'          => 'formatting',
            'mode'              =>  'edit',
        ));
        acf_register_block_type(array(
            'name'              => 'internet-type-blocks',
            'title'             => __('Internet Type Blocks Block'),
            'description'       => __('Internet Type Blocks Block'),
            'render_template'   => 'template-parts/blocks/internet-type-blocks.php',
            'category'          => 'formatting',
            'mode'              =>  'edit',
        ));
        acf_register_block_type(array(
            'name'              => 'small-text',
            'title'             => __('Small Text Block'),
            'description'       => __('Small Text Block'),
        ...
        acf_register_block_type(array(
            ...
            'render_template'   => 'template-parts/blocks/related-posts-block.php',
            'category'          => 'formatting',
            'mode'              =>  'edit',
        ));
    }
